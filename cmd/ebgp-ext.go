...
import (
	...
	"www.github.com/jalapeno/ebgp-ext/pkg/arangodb"
	"www.github.com/jalapeno/ebgp-ext/pkg/kafkamessenger"
...
var (
	...
	peerEdgeV4          string
	peerEdgeV6          string
	unicastprefixEdgeV4 string
	unicastprefixEdgeV6 string
)
...
func init() {
	...
	flag.StringVar(&peerEdgeV4, "peer_edge_v4", "peer_edge_v4", "peer_edge_v4 Collection name, default \"peer_edge_v4\"")
	flag.StringVar(&peerEdgeV6, "peer_edge_v6", "peer_edge_v6", "peer_edge_v6 Collection name, default \"peer_edge_v6\"")
	...
	flag.StringVar(&unicastprefixEdgeV4, "unicast_prefix_edge_v4", "unicast_prefix_edge_v4", "unicast_prefix_edge_v4 Collection name, default: \"unicast_prefix_edge_v4\"")
	flag.StringVar(&unicastprefixEdgeV6, "unicast_prefix_edge_v6", "unicast_prefix_edge_v6", "unicast_prefix_edge_v6 Collection name, default: \"unicast_prefix_edge_v6\"")
}
