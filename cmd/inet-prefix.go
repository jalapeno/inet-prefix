...
import (
	...
	"www.github.com/jalapeno/inet-prefix/pkg/arangodb"
	"www.github.com/jalapeno/inet-prefix/pkg/kafkamessenger"
...
func main() {
	...
	dbSrv, err := arangodb.NewDBSrvClient(dbSrvAddr, dbUser, dbPass, dbName, unicastprefixV4, unicastprefixV6,
